//Task prices
//Given an array of numbers representing stock prices of company in chronological order write a function 
// that calculate maximum profit you could make from buying and selling the stock one time. 
